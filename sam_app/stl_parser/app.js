...
async function getStl(fileId) {
  ...
  const fileByteArray = await stlS3Object.Body.transformToByteArray();
  const fileBase64 = Buffer.from(fileByteArray).toString("base64");

  return {
    statusCode: 200,
    headers: {
      "Content-Type": stlS3Object.ContentType,
      "Content-Length": stlS3Object.ContentLength,
